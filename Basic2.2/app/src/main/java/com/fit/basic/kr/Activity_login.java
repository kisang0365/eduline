...
public class Activity_login extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_login.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                if (isNetworkAvailable()) {
                    ...
                    login_id = id;
                    String url = "http://14.63.223.92/login.php?id=" + id + "&password=" + password;
        ...
        btn_image.setOnClickListener(new Button.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_login.this, Activity_imageUpload.class);
                ...
                if(ok.equals("true")) {
                    ...
                    alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(Activity_login.this, test1.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                            startActivity(intent);
                            finish();
                        }
